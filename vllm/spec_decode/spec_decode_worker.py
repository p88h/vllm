...
class SpecDecodeWorker(LoraNotSupportedWorkerBase):
    ...
    * The scoring forward pass is done without an MQA kernel, which is
    ...
    def _run_no_spec(self, execute_model_req: ExecuteModelRequest,
        ...
        # # if we are executing the prompt, we need to flag the first decode
        # # step since pruning is handled differently
        # if execute_model_req.seq_group_metadata_list[0].is_prompt:
        #TODO WIP
        self.proposer_worker.first_decode_step = True
    ...
    def _run_speculative_decoding_step(
        ...
        self.proposer_worker.first_decode_step = False
